...
namespace Assets.Scripts.Main
{
    class MoveCoordinator : MonoBehaviour
    {
        ...
        private static void ResetPosition()
        {
            ...
            var temp_row = InitScript._instance.randomRow.transform.position;
            temp_row.y = 0;
        ...
        void UpdateRowColPos(Transform trans, float param, bool IsRow)
        {
            ...
            {
                trans.position = Vector3.MoveTowards(trans.position, new Vector3(row_pos, trans.position.x, trans.position.z), row_step);
                if (Math.Abs(trans.position.x - row_pos) <= 0.1f)
                    isColMovingLeft = !isColMovingLeft;
            }
        }
        ...
        void Update()
        {
            ...
            UpdateRowColPos(trans_col, param, false);
